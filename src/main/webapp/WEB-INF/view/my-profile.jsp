...
<!-- Mirrored from askbootstrap.com/preview/groci/theme-three/my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 10:00:29 GMT -->
<head>
<meta charset="utf-8">
<meta name="viewport"
...
<body>
 <script>
  $(document).ready(function() {
	...
	<form action="UpdateCustomerrProfile" method="POST" enctype="multipart/form-data" >
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">First Name <span
														...
														class="form-control border-form-control" value="${customer.firstname}" name="firstname"
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Last Name <span
														class="required">*</span></label> <input
														class="form-control border-form-control" value="${customer.lastName }" name="lastname"
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Phone <span
														class="required">*</span></label> <input
														class="form-control border-form-control" value="${customer.phone_no}" name="number"
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Email Address <span
														class="required">*</span></label> <input
														class="form-control border-form-control " value="${customer.email}" name="email"
...
<div class="cart-sidebar">
	...
	<script src="vendor/jquery/jquery.min.js"
		type="698183c23cc341432a1eef10-text/javascript"></script>
	...
	<script src="cdn-cgi/scripts/rocket-loader.min.js"
		data-cf-settings="698183c23cc341432a1eef10-|49" defer=""></script>
	<script defer
		src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
		integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw=="
		data-cf-beacon='{"rayId":"6e510ada8f2c85fa","version":"2021.12.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}'
