...
<!-- Mirrored from askbootstrap.com/preview/groci/theme-three/my-address.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 10:00:29 GMT -->
<head>
<meta charset="utf-8">
<meta name="viewport"
 ...
 <script>
  $(document).ready(function() {
						...
						<div class="col-md-4">
							<div class="card account-left">
								<div class="user-profile-header">
									<img alt="logo" src="data:image/jpg;base64,${userImage}">
                                    ...
                                    <form action="update-address" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control" value="${shipping.country}"
                                                        placeholder="Enter Country Name" name="scountry" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">City <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${shipping.city}"
                                                        placeholder="Enter City Name" name="scity" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Zip Code <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${shipping.pincode}"
                                                        name="spincode" placeholder="123456" type="number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">State <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${shipping.state} }"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="control-label">Address <span
                                                            class="required">*</span></label>
                                                    <textarea class="form-control border-form-control" name="saddress" >${shipping.address}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="section-header">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Country <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${billing.country }"
                                                        placeholder="Enter Country Name" name="bcountry" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">City <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${billing.city }"
                                                        placeholder="Enter City Name" name="bcity" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Zip Code <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${billing.pincode }"
                                                        name="bpincode" placeholder="123456" type="number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">State <span
                                                            class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="${billing.state }"
                                                        placeholder="Enter State" name="bstate" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="submit" class="btn btn-success btn-lg"> Update Address
                                                </button>
                                            </div>
                                        </div>
                                    </form>
	...
	<script src="vendor/jquery/jquery.min.js"
		type="1090fcea9251fc5c0d25f4b5-text/javascript"></script>
	...
	<script src="cdn-cgi/scripts/rocket-loader.min.js"
		data-cf-settings="1090fcea9251fc5c0d25f4b5-|49" defer=""></script>
	<script defer
		src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
		integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw=="
		data-cf-beacon='{"rayId":"6e510adccebd6ec2","version":"2021.12.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}'
